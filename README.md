...
## 🔭 What I work on
- 🧠 **LLM systems**: RAG pipelines, GraphRAG, reranking, intent routing, tool-using agents
- 📏 **Evals and reliability**: automated scoring, CI canary gates, PII guardrails, faithfulness checks
- ⚡ **Performance**: vLLM serving, KV-cache optimization, quantization, GPU throughput and p95 latency
